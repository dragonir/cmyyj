<!--param start-->
    //修改cdn的绝对路径（测试环境）
    fis.set('cdn-path','https://test.nie.163.com/test_cdn/yys/m/zt/20170508141049');
    //修改cdn的绝对路径（正式环境）
    fis.set('cdn-path-release','https://yys.res.netease.com/m/zt/20170508141049');
